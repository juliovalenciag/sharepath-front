...
const ItinerarioFrame: React.FC<ItinerarioFrameProps> = ({ itinerario }) => {
  ...
  return (
    <>
      ...
      <div className="flex rounded-lg min-h-[300px] w-full">
        <div className="w-1/3 p-4 flex flex-col justify-center px-10">
          ...
          <h3 className="text-xl font-semibold mb-6">{itinerario.subtitulo}</h3>
          ...
          <div className="flex">
            <Button
              className="mt-4 bg-blue-600 hover:bg-blue-800 text-white px-3 py-2 rounded-lg w-auto text-base"
