...
export const Navbar = () => {
  ...
  return (
    <section
      className={cn(
        "bg-background/70 absolute left-1/2 z-50 w-[min(90%,700px)] -translate-x-1/2 rounded-3xl border backdrop-blur-md transition-all duration-300",
        "top-5 lg:top-12"
      )}
    >
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Link href="/sign-up" className="max-lg:hidden">
