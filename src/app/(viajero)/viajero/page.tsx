...
import Estrellas from "@/components/viajero-components/estrellas";
...
const publicaciones = [
  {
    ...
    usuario: {
      ...
      fotoPerfil:
        "https://st5.depositphotos.com/18273866/65276/i/950/depositphotos_652763588-stock-photo-one-man-young-adult-caucasian.jpg",
    },
    itinerario: [
      {
        dia: 1,
    ...
    itinerario: [
      {
        ...
        descripcion:
          "Subida a la Pirámide del Sol al amanecer. Las vistas valen cada escalón.",
      ...
      },
      {
        ...
        descripcion:
          "Visita al Museo de la Cultura Teotihuacana para entender mejor esta civilización.",
  ...
  },
  {
    ...
    usuario: {
      ...
      fotoPerfil:
        "https://i.pinimg.com/236x/9e/1b/7c/9e1b7c47a76007963af0f968a309def7.jpg",
    },
    itinerario: [
      {
        dia: 1,
        ...
        descripcion:
          "Los Prismas Basálticos son una maravilla natural que te dejará sin palabras.",
      ...
      },
      {
        ...
        descripcion:
          "Comida típica en una hacienda del siglo XVI con vistas increíbles.",
      ...
      },
      {
        ...
        descripcion:
          "Recorrido por las calles empedradas de este Pueblo Mágico lleno de encanto.",
  ...
  },
  {
    ...
    usuario: {
      ...
      fotoPerfil:
        "https://plus.unsplash.com/premium_photo-1679769911227-429b4e1b184b?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cmV0cmF0byUyMGRlJTIwYW5jaWFub3xlbnwwfHwwfHx8MA%3D%3D&fm=jpg&q=60&w=3000",
    },
    itinerario: [
      {
        dia: 1,
        ...
        descripcion:
          "Tour y degustación en una vinícola boutique. Los vinos son excelentes.",
      ...
      },
      {
        ...
        descripcion:
          "Visita a una quesería artesanal para probar los famosos quesos de la región.",
      ...
      },
      {
        ...
        descripcion:
          "Ascenso a la Peña de Bernal, el tercer monolito más grande del mundo.",
  ...
  },
  {
    ...
    usuario: {
      ...
      fotoPerfil:
        "https://www.lavanguardia.com/files/content_image_mobile_filter/uploads/2018/07/25/5fa43c9755611.jpeg",
    },
    itinerario: [
      {
        dia: 1,
        ...
        descripcion:
          "Recorrido por las calles empinadas y pintorescas del centro histórico.",
      ...
      },
      {
        ...
        descripcion:
          "Visita a la imponente Iglesia de Santa Prisca, joya del barroco mexicano.",
      ...
      },
      {
        ...
        descripcion:
          "Comida tradicional en un restaurante familiar con pozole excepcional.",
      ...
      },
      {
        ...
        descripcion:
          "Compras de artesanías en plata en los talleres locales de platería.",
...
function PublicacionItem({ publicacion }) {
  ...
  const diasUnicos = [
    ...new Set(publicacion.itinerario.map((item) => item.dia)),
  ];
    ...
    <div className="flex flex-col md:flex-row gap-6 mb-8 p-4 border rounded-lg shadow-sm">
      ...
      <div className="md:w-1/2 space-y-4 relative">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <h3 className="text-base font-semibold text-xl">
          ...
          {actividadActual && (
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm">{actividadActual.horario}</span>
              </div>
...
function Section({
  ...
  return (
    <section
      {...rest}
      className={`max-w-7xl mx-auto px-4 md:px-6 ${className}`}
    >
      {children}
    </section>
  );
...
export default function ViajeroLanding() {
  ...
  const publicacionesConEstado = publicaciones.map((pub) => ({
    ...pub,
    estado: pub.itinerario[0]?.ubicacion?.includes("CDMX")
      ? "CDMX"
      : pub.itinerario[0]?.ubicacion?.includes("Edomex")
      ? "EDOMEX"
      : pub.itinerario[0]?.ubicacion?.includes("Hidalgo")
      ? "Hidalgo"
      : pub.itinerario[0]?.ubicacion?.includes("Guerrero")
      ? "Guerrero"
      : pub.itinerario[0]?.ubicacion?.includes("Querétaro")
      ? "Queretaro"
      : "CDMX",
  }));

  const publicacionesFiltradas = publicacionesConEstado.filter(
    (publicacion) => {
      const coincideTexto =
        publicacion.usuario.nombre
          .toLowerCase()
    ...
    <div className="min-h-[calc(100dvh-64px)]">
      ...
      <Section id="itinerarios">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold mb-2">Descubre</h2>
            <p>
              Descubre los itinerarios compartidos por viajeros y viajeras como
              tú.
            </p>
          </div>
          <SearchFilters
